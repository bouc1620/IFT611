...
private:
    // this peer's id
    usr_t self;
    // the address if the Int32 array on the heap used to exchange position vectors
    // between JavaScript and WebAssembly
    pos_ptr_t posArray_offset;
    // the back-end representation of the collaborative text-editor
...
public:
    ...
    // Document constructor with peer id and the address of the Int32 array on the heap
